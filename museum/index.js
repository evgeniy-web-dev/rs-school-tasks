...
//   console.log(`%cMuseum (добавление JavaScript)`, 'font-weight: bold; font-size: 18px');
//   console.log(`https://github.com/rolling-scopes-school/tasks/blob/master/tasks/museum/museum-dom.md\n\n`);
//   console.log(`%cСамооценка:`, 'font-weight: bold;');
//   console.log(`
//   Выполнены все пункты задания.

//   ✔️ Слайдер в секции Welcome +24
//   ✔️ Слайдер в секции Video +20
//   ✔️ Кастомный видеоплеер +36
//   ✔️ Слайдер сравнения изображений в секции Explore +10
//   ✔️ Анимация при прокрутке изображений в секции Galery +8
//   ✔️ Калькулятор продажи билетов в секции Tiskets +10
//   ✔️ Калькулятор продажи билетов в форме продажи билетов +14
//   ✔️ Валидация формы +16
//   ✔️ Интерактивная карта в секции Contacts +12
//   ✔️ Дополнительный функционал (кнопка прокрутки страницы вверх) +10
// `);
//   console.log(`%cИтого: 160/160`, 'font-weight: bold');
// }
